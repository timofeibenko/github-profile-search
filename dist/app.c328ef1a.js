...
function printUserCard(user) {
  ...
  const card = "<aside class=\"sidebar\">\n                    <img class=\"sidebar__profile-pic\"\n                         id=\"profile_pic\"\n                         src=".concat(user.avatar_url, "\n                         alt=\"").concat(user, " GitHub profile picture\"\n                    >\n                </aside>\n\n                <section class=\"profile-info\">\n                    <h2 class=\"profile-info__name\">").concat(user.login, "</h2>\n                    <p class=\"profile-info__description\">\n                    ").concat(function () {
    if (user.bio === null) {
      return '';
    } else {
      return user.bio;
    }
  }(), "\n                    </p>\n                    <ul class=\"profile-info__statistics-list\">\n                        <li class=\"profile-info__statistics-item\"><span>").concat(user.followers, "</span>&nbsp;Followers</li>\n                        <li class=\"profile-info__statistics-item\"><span>").concat(user.following, "</span>&nbsp;Following</li>\n                        <li class=\"profile-info__statistics-item\"><span>").concat(user.public_repos, "</span>&nbsp;Repos</li>\n                    </ul>\n                </section>");
